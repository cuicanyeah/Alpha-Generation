...
DATA_DIR=$(pwd)/data_for_alphaevolve # _preds

bazel --output_user_root=/hdd9/james/folder_to_make_space_for_home/bazel/_bazel_james run -c opt \
  ...
  --copt=-DMAX_MATRIX_ADDRESSES=25 \
    :run_search_experiment -- \
      ...
      --all_timesteps=${all_timesteps:-1244} \
