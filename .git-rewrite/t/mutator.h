...
class Mutator {
 ...
 private:
  ...
  void InsertInstructionUnconditionally(
      const Op op,
      std::vector<std::shared_ptr<const Instruction>>* component_function, ComponentFunctionT component_functionT);
  ...
  InstructionIndexT InstructionIndex(InstructionIndexT component_function_size, ComponentFunctionT component_functionT);
